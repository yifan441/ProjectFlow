  ...
  return (
    <>
      <div className="task">
          ...
          <div className="rename-button" style={{ display: 'inline-block', cursor: 'pointer' }}>
            ...
            >
              ...
              <path
                ...
                fill="#7D7C78"
                mask="url(#path-1-outside-1_222_240)"
              />
              <path d="M12.5 7.5L15.5 5.5L18.5 8.5L16.5 11.5L12.5 7.5Z" fill="#7D7C78" />
            </svg>
            <RenameTask
        ...
        <div className="field" id="task-priority-div">
        ...
        <div className="field" id="task-date-div">
          <DatePicker
            selected={dueDate}
        ...
        <div className="field" id="task-delete-btn-div" style={{ display: 'inline-block' }}>
          <svg
            onClick={() => {
